package net.vadamdev.viaapi.api.inv;

import net.vadamdev.viaapi.VIAPI;
import net.vadamdev.viaapi.api.inv.content.InventoryContents;
import net.vadamdev.viaapi.api.inv.content.InventoryProvider;
import net.vadamdev.viaapi.api.inv.opener.InventoryOpener;
...
public class SmartInventory {
    ...
    public static final class Builder {
        ...
        public SmartInventory build() {
            ...
            InventoryManager manager = this.manager != null ? this.manager : VIAPI.getInvManager();
